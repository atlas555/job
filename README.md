...
档和自动化部署工具：Svn/Git/PHPDoc/Phing/Composer
...
首先，一份好的简历不光说明事实，更通过FAB模式来增强其说服力。
 ...
 - Feature：是什么
  - Advantage：比别人好在哪些地方
   ...
   其次，写简历和写议论不同，过分的论证会显得自夸，反而容易引起反感，所以要点到为止。这里的技巧是，提供论据，把论点留给阅读简历的人自己去得出。放论据要具体，最基本的是要数字化，好的论据要让人印象深刻。
   ...
   章，好的章可以从侧面证实你的表达和沟通能力，也帮助招聘方更了解你）
   
   - [一个产品经理眼中的云计算：前生今世和未来](http://get.jobdeer.com/706.get)
   - [来自HeroKu的HTTP API 设计指南(翻译章)](http://get.jobdeer.com/343.get) （ ```好的翻译章可以侧证你对英技术档的阅读能力```）
   ...
   （放置你代表公司在一些技术会议上做过的演讲，以及你在公司分享时制作的讲义）
     ...
     - 2014架构师大会演讲：[如何通过Docker优化内部开发](http://jobdeer.com)
      ...
      - 版本管理、具体、量化、有说服力，是技术简历特别需要注重的地方。
   ...
   - Email：goodman@gmail.com （```虽然我觉得QQ邮箱1所谓，不过有些技术人员比较反感，建议用G```）
